...
void	clear_program(t_context_ph *context_ph)
{
	...
	if (context_ph->mutex_death_alert != NULL)
		clear_mutex(context_ph->mutex_death_alert);
	if (context_ph->mutex_meal_alert != NULL)
		clear_mutex(context_ph->mutex_meal_alert);
	if (context_ph->mutex_meal_finished != NULL)
		clear_mutex(context_ph->mutex_meal_finished);
}
